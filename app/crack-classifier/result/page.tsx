      ...
      <div className="min-h-screen bg-[#0a1428] text-white pb-20">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="bg-[#1e2937] rounded-3xl p-10 shadow-2xl border border-gray-700">
            <h2 className="text-4xl font-bold text-center mb-10 text-[#0f6cbd]">📋 Crack Tooth Classification Result</h2>
            ...
            {/* Iowa Classification */}
            {result.iowaStage && (
              <div className="bg-[#0f172a] rounded-3xl p-10 mb-12 border border-gray-600 text-center">
                <p className="text-lg text-gray-400 mb-1">Iowa Classification (Krell & Caplan)</p>
                <p className="text-6xl font-bold text-[#10b981] mb-4">Stage {result.iowaStage}</p>
                <p className="text-3xl font-bold text-[#60a5fa]">
                  {result.successRate} <span className="text-xl font-normal text-gray-400">1-year success rate after treatment</span>
                </p>
              </div>
            )}
