  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a1428] text-white">
        {/* Hero Header */}
        <div className="bg-gradient-to-br from-blue-950 to-[#0a1428] py-12 sm:py-16 border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div>
                ...
                <p className="text-xl sm:text-2xl text-blue-300 mt-3">Personalized Evidence-Based Management</p>
              </div>
