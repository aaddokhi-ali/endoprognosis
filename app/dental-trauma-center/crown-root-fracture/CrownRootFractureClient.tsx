  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0a1428] text-white">
        {/* Hero Header */}
        <div className="bg-gradient-to-br from-amber-950 to-[#0a1428] py-12 sm:py-16 border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div>
                ...
                <p className="text-xl sm:text-2xl text-amber-300 mt-3">Crown-Root • Root • Alveolar Fractures — Personalized Management</p>
              </div>
